...
//             <h3 className="text-3xl font-normal mb-4">A secure Digital Wallet to transfer and receive money to/from users</h3>
//             <button
...
//                 Get Started Today
//             </button>
//             <footer className="w-full absolute bottom-0 bg-gray-100 text-center py-4">
