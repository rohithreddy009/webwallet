    ...
    return (
        <div className="shadow h-14 flex justify-between items-center px-4 bg-black">
            <div className="text-white border border-white p-2 m-2 flex items-center">
                ...
                <span className="md:inline hidden">Web2 Wallet</span> {/* Web2 Wallet text will be hidden on smaller screens */}
            </div>

            <div className="flex items-center">
                <div className="text-white m-2 hidden sm:block">Hello, {userName}</div> {/* Adjusted for consistency */}
                ...
                >
                    History <History className="w-5 h-5 sm:block hidden"/> {/* History icon only appears on larger screens */}
                </button>
                <button
                ...
                >
                    Logout <LogoutIcon className="w-5 h-5"/> {/* Logout icon is always visible */}
                </button>
            </div>
        </div>
    );
